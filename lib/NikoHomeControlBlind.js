...
NikoHomeControlBlind.prototype.changeTarget = function(oldValue, newValue) {
    ...
    if (null === oldValue && false === this.running) {
        ...
        this.accessory.state = 2;
        this.accessory.getService(this.accessory.displayName).getCharacteristic(Characteristic.CurrentPosition).updateValue(this.accessory.position);
        this.accessory.getService(this.accessory.displayName).getCharacteristic(Characteristic.TargetPosition).updateValue(this.accessory.target);
        this.accessory.getService(this.accessory.displayName).getCharacteristic(Characteristic.PositionState).updateValue(this.accessory.state);
